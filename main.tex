...
\input{ESEMPI DI CODICE/funzioni}
...
%%%%% Title %%%%%
\input{front_matter/frontespizio}
%\stepcounter{page}
...
%\part*{Introduction}
\input{main_matter/01-Introduzione}
\let\cleardoublepage\clearpage

\chapter{Strumentazione}
\input{main_matter/02-Strumentazione}
\clearpage\null\thispagestyle{empty}

\chapter{Implementazione}
\input{main_matter/03-Implementazione}
\clearpage\null\thispagestyle{empty}

\addcontentsline{toc}{chapter}{Conclusioni}
\chapter*{Conclusioni}
\input{main_matter/98-Conclusioni}

\addcontentsline{toc}{chapter}{Bibliografia}
\chapter*{Bibliografia}
\input{main_matter/100-Bibliografia}

\addcontentsline{toc}{chapter}{Ringraziamenti}
\chapter*{Ringraziamenti}
\input{main_matter/101-Ringraziamenti}

%\chapter{TODO NAME OF CODE CHAPTER}
%\input{main_matter/99-All-Codes_Chapter}

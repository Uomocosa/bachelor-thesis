...
\begin{minted}{Arduino}
    ...
    // -----------------------------------------------------------------------
    // Otteniamo così: i tempi in ms impiegati del classificatore
    // result.timing.dsp
    // result.timing.classification
    // result.timing.anomaly
    
    // Inoltre:
    // result.classification[ix].label //Ritorna una stringa con il label
    // result.classification[ix].value //Valore della confidenza tra 0 ed 1
    // result.anomaly //Valore dell'anomalia se implementata precedentemente
\end{minted}

Quindi con \mintinline{arduino}{result.classification[ix].label}, \mintinline{arduino}{result.classification[ix].value}, e \mintinline{arduino}{result.anomaly} è possibile implementare il resto del codice:
...
\myNOTE{
In questo caso \mintinline{arduino}{result.anomaly} non è stata implementata. In caso si volesse implementare\\
